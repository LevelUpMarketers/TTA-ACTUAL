...
*   [Demo 1 - Background Slider](https://democomingsoon.wpdevart.com)
*   [Demo 2 - Video Background](https://democs.wpdevart.com)
...
You can upgrade the free version to [Coming soon and Maintenance mode Pro](https://wpdevart.com/wordpress-coming-soon-plugin/) to add some features.
...
[WordPress Under construction plugin](https://wpdevart.com/best-wordpress-under-construction-plugin/) is a user friendly plugin, but here you can see some frequently asked questions that will help you.
...
Yes, you can use WordPress standard text editor for inserting images or videos.
...
then you just need to type there '0AqnCSdkjQ0' (option will appear if you choose 'YouTube Background' type).
...
*  Changed some descriptions in admin menu.
...
*  Edit menu options and descriptions.
...
*  Edited featured plugin information.

= 3.1.3 ==

*  Edited plugin admin panel.
...
*  Added text for option.

= 3.2.4 ==

*  Fix spelling mistakes in the admin panel.
...
*  Changed contact form icon.

= 3.2.7 ==

*  Added coming soon page text.

= 3.2.8 ==

*  Edit the admin option titles.
...
*  Added new featured plugin - chart.

= 3.3.1 ==

*  Added another featured plugin to the list.

= 3.3.2 ==

*  Corrected plugin texts.
...
*  Added countdown, lightbox and gallery new icons.

= 3.3.7 ==

*  Changed the design of featured plugins page.

= 3.3.8 ==

*  Changed Subscribers and options page styles in the admin panel.

= 3.3.9 ==

*  Changed some option names from the admin panel.

= 3.4.0 ==

*  Removed the Google plus.

= 3.4.1 ==

*  Changed the default page logo.

= 3.4.2 ==

*  Changed the default background color and added descriptions for the SEO options.

= 3.4.3 ==

*  Bug fixed - footer message.

= 3.4.4 ==

*  Changed some option texts.
...
*  Added a style to the Featured Plugins page title.

= 3.4.7 ==

*  Changed some texts on the "Subscribers" page.

= 3.4.8 ==

*  Changed the Countdown option name.

= 3.4.9 ==

*  New featured plugin icon added.
...
*  Changed some styles in the admin panel.
...
*  Changed an option name and fixed URL mistake.

= 3.5.7 ==

*  Corrected social buttons texts.

= 3.5.8 ==

*  Improved description texts of options.

= 3.5.9 ==

*  Fixed spelling mistakes and added some descriptions.

= 3.6.0 ==

*  Corrected some mistakes in the plugin files.
...
*  Corrected the Logo section texts.

= 3.6.3 ==

*  Corrected the Title and Message sections texts.

= 3.6.4 ==

*  Corrected the countdown timer section texts.

= 3.6.5 ==

*  Corrected the Progress bar section texts.

= 3.6.6 ==

*  Corrected the Form section texts.
...
*  Changed the descriptions of the admin options.
